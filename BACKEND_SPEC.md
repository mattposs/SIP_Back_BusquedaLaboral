...
- `GET /candidates/me/validators` — list validators who validated the current candidate's skills, returns `CandidateValidatorDetailResponse[]` (same schema as in §3.1)
